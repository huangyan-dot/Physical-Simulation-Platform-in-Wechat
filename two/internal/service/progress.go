...
func (s *ProgressService) Mine(userID int64) (*model.ProgressView, error) {
...
func (s *ProgressService) Submit(userID, levelID int64, experimentCode string, readingsRaw, userConfigRaw json.RawMessage) (*SubmitResult, error) {
	...
	score, passed, detail, err := scoreByExperiment(exp.Code, readingsRaw, exp.Target, userConfigRaw)
	if err != nil {
